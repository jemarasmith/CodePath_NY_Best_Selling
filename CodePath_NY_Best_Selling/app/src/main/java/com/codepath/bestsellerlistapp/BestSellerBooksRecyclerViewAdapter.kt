...
class BestSellerBooksRecyclerViewAdapter(
    ...
    inner class BookViewHolder(val mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        val mRanking: TextView = mView.findViewById(id.ranking) as TextView
        val mBuyBook: Button = mView.findViewById(id.buy_button) as Button
